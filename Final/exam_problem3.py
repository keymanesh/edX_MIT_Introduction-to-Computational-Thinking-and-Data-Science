...
def runSimulation(numSteps):
    ...
    pylab.scatter(range(numSteps),rabbit_populations)
    pylab.scatter(range(numSteps),fox_populations, color="r")

    coeff = pylab.polyfit(range(len(rabbit_populations)), rabbit_populations, 2)

    pylab.plot(pylab.polyval(coeff, range(len(rabbit_populations))), color="b")

    coeff = pylab.polyfit(range(len(fox_populations)), fox_populations, 2)

    pylab.plot(pylab.polyval(coeff, range(len(fox_populations))), color = "r")
